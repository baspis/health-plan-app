...
export const PREP_ITEMS: PrepItem[] = [
  // ===== Tools (10 items: 8 + tool-food-initial を 3 分割) =====
  {
    ...
    spec: {
      ...
      primaryLink: {
        label: 'Amazon: ループ式 抵抗バンド 3 段階',
        url: 'https://www.amazon.co.jp/s?k=resistance+loop+bands+heavy+set'
      },
      avoid: [
  ...
  },
  {
    ...
    spec: {
      ...
      primaryLink: {
        label: 'Amazon: マイプロテイン Metal Shaker',
        url: 'https://www.amazon.co.jp/s?k=myprotein+metal+shaker'
      },
      altLinks: [
        {
          label: 'Amazon: シービージャパン プロテインシェイカー',
          url: 'https://www.amazon.co.jp/s?k=%E3%82%B7%E3%83%BC%E3%83%93%E3%83%BC%E3%82%B8%E3%83%A3%E3%83%91%E3%83%B3+%E3%82%B7%E3%82%A7%E3%82%A4%E3%82%AB%E3%83%BC'
        }
      ],
      avoid: [
  ...
  },
  {
    id: 'tool-bottle',
    group: 'tools',
    title: '1 L 水筒（サーモス JNR-1000）',
    summary: 'デスク常設、水 2 L/日 用',
    cost: '¥3,000',
    spec: {
      must: [
        '型番 JNR-1000（容量 1000 ml）',
        '真空断熱ステンレス',
        'ワンタッチ開閉式',
        '飲み口の口径 4 cm 以上（洗いやすさ）'
      ],
      why: 'デスク常設、空になったら即補充ルーチンに最適。500 ml だと補充頻度が高くなり摩擦増。',
      primaryLink: {
        label: 'Amazon: サーモス JNR-1000',
        url: 'https://www.amazon.co.jp/s?k=%E3%82%B5%E3%83%BC%E3%83%A2%E3%82%B9+JNR-1000+1L'
      },
      avoid: [
        '500 ml の小型（補充頻度高すぎ）',
        '保温なしのプラスチック樹脂タイプ',
  ...
  },
  {
    ...
    spec: {
      ...
      primaryLink: {
        label: 'Amazon: ジップロック コンテナー 正方形 700ml 10個入',
        url: 'https://www.amazon.co.jp/s?k=%E3%82%B8%E3%83%83%E3%83%97%E3%83%AD%E3%83%83%E3%82%AF+%E3%82%B3%E3%83%B3%E3%83%86%E3%83%8A%E3%83%BC+%E6%AD%A3%E6%96%B9%E5%BD%A2+700ml+10%E5%80%8B%E5%85%A5'
      },
      avoid: [
        '楕円形・長方形（積み重ね効率が悪い）',
  ...
  },
  {
    ...
    spec: {
      ...
      primaryLink: {
        label: 'Amazon: ジップロック コンテナー 正方形 500ml 4個入',
        url: 'https://www.amazon.co.jp/s?k=%E3%82%B8%E3%83%83%E3%83%97%E3%83%AD%E3%83%83%E3%82%AF+%E3%82%B3%E3%83%B3%E3%83%86%E3%83%8A%E3%83%BC+%E6%AD%A3%E6%96%B9%E5%BD%A2+500ml'
      },
      avoid: [
  ...
  },
  {
    ...
    spec: {
      ...
      why: '日本高血圧学会の家庭血圧ガイドラインは上腕式を推奨。手首式は精度がブレやすく医療判断に使えない。',
      primaryLink: {
      ...
      altLinks: [
        {
          label: 'Amazon: オムロン 上腕式血圧計（一般）',
          url: 'https://www.amazon.co.jp/s?k=%E3%82%AA%E3%83%A0%E3%83%AD%E3%83%B3+%E4%B8%8A%E8%85%95%E5%BC%8F%E8%A1%80%E5%9C%A7%E8%A8%88'
        }
      ],
      avoid: [
